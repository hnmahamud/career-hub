...
const Blogs = () => {
  return (
    <div className="w-[95%] md:w-[80%] mx-auto flex flex-col space-y-4 my-12">
      <div className="card card-side border-2 rounded-sm p-4">
        <div className="col-span-2 card-body">
          <div className="flex flex-col space-y-4">
            ...
            <p>
              ...
              with deeply nested components within a medium to large-sized React
              application. By leveraging the Context API, you can avoid prop
              drilling, centralize state management, and provide a scalable and
              organized approach to handling shared data across your components.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="col-span-2 card-body">
          <div className="flex flex-col space-y-4">
            ...
            <p>
              ...
              promotes code reusability. It follows a naming convention of "use"
              followed by a descriptive name, like "useFetch" or
              "useLocalStorage." Custom hooks utilize React's built-in hooks and
              can have their own state, returning values, objects, or functions.
              They enable efficient and modular code by eliminating duplication
              and promoting separation of concerns. Custom hooks are a powerful
              tool for creating concise and scalable React applications.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="col-span-2 card-body">
          <div className="flex flex-col space-y-4">
            ...
            <p>
              ...
              computation and returning the cached result when the inputs to the
              computation have not changed. It helps prevent unnecessary
              ...
              change. Memoize expensive operations like sorting or filtering to
